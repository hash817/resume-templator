    ...
    <AppProvider>
      <EditContextProvider>
        <SettingContextProvider>
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-5 p-4">
            ...
            <div className="bg-gray-500 shadow-lg rounded-md p-4 md:col-span-2 lg:col-span-4 mx-auto w-[231mm] h-[326mm]">
              <PageContextProvider>
                <PreviewResume />
              </PageContextProvider>
            </div>
